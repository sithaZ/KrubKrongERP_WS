...
abstract class AppTheme {
  ...
  static TextTheme _baseForLocale(Locale locale) {
    if (locale.languageCode == AppLocale.khmer.languageCode) {
  ...
  static TextTheme _textThemeForLocale(Locale locale) {
    final base = _baseForLocale(locale);
    return base.copyWith(
      displayLarge: base.displayLarge?.copyWith(
        fontSize: 32,
        fontWeight: FontWeight.w700,
        letterSpacing: locale.languageCode == 'km' ? 0 : -0.8,
      ),
      displayMedium: base.displayMedium?.copyWith(
        fontSize: 28,
        fontWeight: FontWeight.w700,
        letterSpacing: locale.languageCode == 'km' ? 0 : -0.6,
      ),
      displaySmall: base.displaySmall?.copyWith(
        fontSize: 24,
        fontWeight: FontWeight.w600,
        letterSpacing: locale.languageCode == 'km' ? 0 : -0.4,
      ),
      headlineLarge: base.headlineLarge?.copyWith(
        fontSize: 22,
        fontWeight: FontWeight.w600,
        letterSpacing: locale.languageCode == 'km' ? 0 : -0.3,
      ),
      headlineMedium: base.headlineMedium?.copyWith(
        fontSize: 18,
        fontWeight: FontWeight.w600,
        letterSpacing: locale.languageCode == 'km' ? 0 : -0.2,
      ),
      ...
      labelLarge: base.labelLarge?.copyWith(
        fontSize: 14,
        fontWeight: FontWeight.w600,
        letterSpacing: locale.languageCode == 'km' ? 0 : 0.1,
      ),
      ...
      labelSmall: base.labelSmall?.copyWith(
        fontSize: 10,
        fontWeight: FontWeight.w500,
        letterSpacing: locale.languageCode == 'km' ? 0 : 0.5,
      ),
    );
  }

  static TextTheme get textTheme => _textThemeForLocale(const Locale('en'));
  static ThemeData get lightTheme => lightThemeForLocale(const Locale('en'));
  static ThemeData get darkTheme => darkThemeForLocale(const Locale('en'));

  static ThemeData themeForLocale(Locale locale, Brightness brightness) {
  ...
  static ThemeData lightThemeForLocale(Locale locale) {
    ...
    final textTheme = _textThemeForLocale(locale);
